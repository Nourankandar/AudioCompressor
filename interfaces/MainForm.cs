...
namespace AudioCompressor.interfaces
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            btnCompress.Click += (s, e) => clickHelper.BtnCompress_Click(cbAlgorithm, numSampleRate, numQuantization, progressBar, btnCancel);
        ...
        private void SetupUI()
        {
            ...
            btnCancel = CreateModernButton("Cancel", 190, 275, 160, 45, Color.FromArgb(220, 38, 38), Color.White);
            btnCancel.Visible = false; // إخفاء زر الإلغاء في البداية
